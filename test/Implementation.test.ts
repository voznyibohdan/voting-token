...
describe('Implementation Contract', () => {
    ...
    describe('Initial state', () => {
        it('Should set correct initial state', async () => {
            const { implContract, initialPrice, initialMinTokenAmount, initialFeePercentage } =
    ...
    describe('TransferFrom', () => {
        it('Should revert', async () => {
            ...
            await expect(
                implContract.connect(testAccount).transferFrom(testAccount.address, toAccount.address, 1),
